...
class TestCommit:
    ...
    def test_to_dict(self, mock_git_commit):
        ...
        assert commit_dict["hash"] == "abcdef1234567890abcdef1234567890abcdef12"
    ...
    def test_equality(self, mock_git_commit):
        ...
        mock_git_commit2.stats.total = {"insertions": 0, "deletions": 0, "files": 0}
...
class TestBranch:
    ...
    def mock_remote_branch(self):
        ...
        mock_branch.__class__.__name__ = "RemoteReference"  # For remote detection
    ...
    def test_equality(self, mock_git_branch):
        ...
        branch2 = Branch(mock_git_branch, is_active=False)  # Different active status
        ...
        mock_git_branch2.commit.stats.total = {"insertions": 0, "deletions": 0, "files": 0}
