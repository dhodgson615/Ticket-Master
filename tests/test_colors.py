...
from ticket_master_consolidated import CYAN  # Global color variables
from ticket_master_consolidated import (BLUE, BOLD, DIM, END, GRAY, GREEN, ITALIC, MAGENTA, RED,
