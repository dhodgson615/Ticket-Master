...
class TestAppConfiguration:
    ...
    def test_secret_key_set(self):
        ...
        expected = os.getenv("FLASK_SECRET_KEY", "dev-key-please-change-in-production")
    ...
    def test_index_route_get(self):
        ...
        with app.app.test_client() as client:
            with patch('app.render_template') as mock_render:
                ...
                mock_render.assert_called_once_with("index.html", version=app.__version__)
...
class TestGenerateIssuesRoute:
    ...
    def test_generate_issues_missing_repo(self, mock_load_config, mock_github_utils):
    ...
    @patch('app.GitHubUtils')
    @patch('app.load_config')
    def test_generate_issues_empty_repo(self, mock_load_config, mock_github_utils):
    ...
    @patch('app.GitHubUtils')
    @patch('app.load_config')
    def test_generate_issues_invalid_repo_format(self, mock_load_config, mock_github_utils):
        ...
        mock_utils_instance.parse_github_url.side_effect = ValueError("Invalid format")
    ...
    def test_generate_issues_private_repo_no_token(self, mock_repository, mock_load_config, mock_github_utils):
        ...
        mock_utils_instance.is_public_repository.return_value = False  # Private repo
        mock_github_utils.return_value = mock_utils_instance
        
        with app.app.test_client() as client:
            response = client.post('/generate', data=self.form_data, follow_redirects=True)
    ...
    @patch('app.load_config')
    @patch('app.Repository')
    def test_generate_issues_nonexistent_local_path(self, mock_repository, mock_load_config, mock_github_utils):
        ...
        with app.app.test_client() as client:
            response = client.post('/generate', data=form_data, follow_redirects=True)
    ...
    def test_generate_issues_with_local_path(self, mock_exists, mock_generate, mock_repository, mock_load_config, mock_github_utils):
        ...
        mock_repo_instance.analyze.return_value = {
            ...
            "summary": {"commit_count": 0, "files_modified": 0, "files_added": 0}
        }
    ...
    @patch('app.GitHubUtils')
    @patch('app.load_config')
    def test_generate_issues_clone_failure(self, mock_load_config, mock_github_utils):
        ...
        mock_utils_instance.parse_github_url.return_value = self.test_repo
        mock_utils_instance.is_public_repository.return_value = True
        mock_utils_instance.clone_repository.side_effect = app.GitHubCloneError("Clone failed")
        mock_github_utils.return_value = mock_utils_instance
    ...
    @patch('app.load_config')
    @patch('app.Repository')
    def test_generate_issues_repository_error(self, mock_repository, mock_load_config, mock_github_utils):
    ...
    @patch('app.Repository')
    @patch('app.generate_sample_issues')
    def test_generate_issues_success_public_repo(self, mock_generate, mock_repository, mock_load_config, mock_github_utils):
        ...
        mock_repo_instance.analyze.return_value = {
            ...
            "summary": {"commit_count": 1, "files_modified": 0, "files_added": 1}
        }
        mock_repository.return_value = mock_repo_instance
...
class TestAppErrorHandling:
    ...
    @patch('app.load_config')
    @patch('app.Repository')
    def test_general_exception_handling(self, mock_repository, mock_load_config, mock_github_utils):
