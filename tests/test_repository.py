...
class TestRepository:
    ...
    def test_get_commit_history(self, temp_git_repo):
        ...
        commit = commits[0]
        required_keys = ['hash', 'short_hash', 'author', 'committer', 'message', 'summary', 'date']
    ...
    def test_get_repository_info(self, temp_git_repo):
        ...
        required_keys = ['path', 'name', 'active_branch', 'total_commits', 'branches', 'is_dirty']
        for key in required_keys:
            assert key in info
    ...
    def test_get_file_changes(self, temp_git_repo):
        ...
        required_keys = ['modified_files', 'new_files', 'deleted_files', 'renamed_files', 'summary']
        for key in required_keys:
...
class TestRepositoryErrorHandling:
    ...
    @patch('ticket_master.repository.Repo')
    ...
    def test_commit_history_with_invalid_branch(self, temp_git_repo_for_error_tests):
    ...
    @patch('ticket_master.repository.subprocess.run')
    def test_is_ignored_with_subprocess_error(self, mock_run, temp_git_repo_for_error_tests):
